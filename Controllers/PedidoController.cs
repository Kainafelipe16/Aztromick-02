...
namespace Aztromick2.Controllers
{
    ...
    public class PedidoController : Controller
    {
        ...
        {
            UserAccount userlogado = _context.Users.FirstOrDefault(p => p.UserName == User.Identity.Name);
            Pedido p = new Pedido
            {
        ...
        public string EnviarMensagem(int pedidoId)
        {
            ...
            string numeroDestinatario = "+5519123456789";
